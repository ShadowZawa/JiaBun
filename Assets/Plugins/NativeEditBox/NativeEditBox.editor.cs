...
public partial class NativeEditBox
{
	...
	void OnEndEdit(string text)
	{
		...
		if (keyboard != null)
			isSubmit = keyboard.enterKey.wasPressedThisFrame || keyboard.numpadEnterKey.wasPressedThisFrame;
#elif ENABLE_LEGACY_INPUT_MANAGER
		isSubmit = Input.GetKey(KeyCode.KeypadEnter) || Input.GetKey(KeyCode.Return);
#endif
